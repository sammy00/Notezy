...
function PersistentWorkspaces() {
  ...
  const tasksActive = pathname.endsWith("/tasks");

  return (
    <div className="notezy-persistent-workspaces">
      <div className="notezy-persistent-workspace" hidden={tasksActive}>
        <NoteWorkspace />
      </div>
      <div className="notezy-persistent-workspace" hidden={!tasksActive}>
        <TaskWorkspace />
...
function AppLaunchSkeleton() {
  return (
    <div
      className="notezy-launch-skeleton"
      aria-label="Loading Notezy"
      aria-busy="true"
    >
      <aside>
